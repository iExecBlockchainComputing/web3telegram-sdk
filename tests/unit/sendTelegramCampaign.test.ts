...
describe('sendTelegramCampaign', () => {
    ...
    beforeAll(async () => {
        ...
        testedModule = await import('../../src/web3telegram/sendTelegramCampaign.js');
        sendTelegramCampaign = testedModule.sendTelegramCampaign;
    });

    describe('Bulk processing', () => {
        it('should call processBulkRequest when campaignRequest is provided', async () => {
            // --- GIVEN
        ...
        it('should throw error when campaignRequest is not provided', async () => {
            ...
            await expect(
                ...
                message: expect.stringMatching(/Failed to sendTelegramCampaign|Missing parameter/),
            });
        ...
        it('should handle errors correctly', async () => {
            ...
            const mockDataprotector = {
                processBulkRequest: jest.fn<() => Promise<any>>().mockRejectedValue(mockError),
            } as any;
        ...
        it('should re-throw protocol errors without modification', async () => {
            ...
            const mockDataprotector = {
                processBulkRequest: jest.fn<() => Promise<any>>().mockRejectedValue(protocolError),
            } as any;
        ...
        it('should handle "Failed to process protected data" error', async () => {
            ...
            const mockDataprotector = {
                processBulkRequest: jest.fn<() => Promise<any>>().mockRejectedValue(processError),
            } as any;
