...
describe('web3telegram.sendTelegram() - Bulk Processing', () => {
    ...
    describe('Bulk telegram sending', () => {
        it(
            ...
            async () => {
                ...
                // Prepare telegram content encryption and upload (like sendTelegram does for single)
                const telegramContent = 'Bulk test message';
                ...
                const encryptedFile = await iexec.dataset.encrypt(
                    Buffer.from(telegramContent, 'utf8'),
                ...
                // Prepare secrets like sendTelegram does
                const secrets = {
                    1: JSON.stringify({
